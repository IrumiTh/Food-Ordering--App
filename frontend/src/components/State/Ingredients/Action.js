...
import { CREATE_INGREDIENT_CATEGORY_SUCCESS, CREATE_INGREDIENT_SUCCESS, GET_INGREDIENT_CATEGORY_REQUEST, GET_INGREDIENTS, UPDATE_STOCK } from "./ActionType";
...
export const updateStockOfIngredient = ({ id, jwt}) => {
    return async (dispatch) => {
        try {
            ...
            console.log( "ingredinet stock",data)
        } catch (error) {
            console.log("error ", error);
        }
    }
